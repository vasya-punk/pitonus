...
package data.utils
{
    ...
    public function parseTreeRecursive( obj : Object,  name:String = "def", d : uint = 0 ) : DataNode {
            ...
            if ( !(obj[propertyName] is String) ) {
				...
				if ( propertyName == 'pages'  || propertyName == 'elements' ) {
					...
					for ( child in obj[propertyName] ) {
						...
						rc = parseTreeRecursive( obj[propertyName][child], child as String, d );
				...
				(node as DataNode).addProperties(obj);
        }
